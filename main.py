...
kost_list = [
  "Kost Paviliun Pondok Al Affan", "Kost UZ", "Kost Violet", "Kost Bougenville", "Kost Bumi Kiara","Kost Puri Indah 3", "Kost Wisma Citra", "Kost Puri Indah 3", "Villa Zone Kost", "Kost Pondok Amanah",
    ...
    "Kost Pondok Buah Batu 3", "Kost Dayeuhkolot Ceria 2", "Kost Taman Buah Batu 5","Kost Green Residence Dayeuhkolot", "Kost Buah Batu Maju", "Kost Dayeuhkolot Nirwana"
]

kost_prices = [
   866567, 1075264, 979472, 1409875, 950886,
...
1206283 ,1282557 ,1444309 ,1356349 ,1014485 ,
...
plt.title("Time Complexity Comparison (Iterative)", fontsize=14)
...
plt.xlabel("Input Size", fontsize=12)
plt.ylabel("Execution Time (seconds)", fontsize=12)
plt.title("Time Complexity Comparison (Recursive)", fontsize=14)
plt.gca().invert_xaxis()  # Membalik sumbu X
plt.legend()
plt.grid(True, linestyle="--", linewidth=0.5)
plt.tight_layout()
